    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        return http
                ...
                .authorizeHttpRequests(exchanges -> exchanges
                        ...
                        .requestMatchers(org.springframework.http.HttpMethod.POST, "/graphql").authenticated()
                        .requestMatchers(org.springframework.http.HttpMethod.GET, API_V1_PATTERN).authenticated()
                        .requestMatchers(org.springframework.http.HttpMethod.POST, API_V1_PATTERN).hasRole(ROLE_ADMIN)
                        .requestMatchers(org.springframework.http.HttpMethod.PUT, API_V1_PATTERN).hasRole(ROLE_ADMIN)
                        .requestMatchers(org.springframework.http.HttpMethod.DELETE, API_V1_PATTERN).hasRole(ROLE_ADMIN)
                        .anyRequest().denyAll())
