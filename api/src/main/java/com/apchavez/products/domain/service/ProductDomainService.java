...
public class ProductDomainService {
    ...
    /** Backs the GraphQL {@code products} query — see {@link ProductRepositoryPort#findAllActiveLight}. */
    public List<Product> listActiveProductsLight(int page, int size) {
        return repositoryPort.findAllActiveLight(page, size);
    }
    ...
    public List<Product> searchByCategoryAndPriceRange(Integer categoryId, Double minPrice, Double maxPrice) {
        return repositoryPort.searchByCategoryAndPriceRange(categoryId, minPrice, maxPrice);
    }
    ...
    public Product updateProduct(Integer id, Product updatedData) {
        ...
        return repositoryPort.update(
                new Product(id, updatedData.sku(), updatedData.name(), updatedData.description(),
                        updatedData.categoryId(), updatedData.categoryName(), updatedData.price(),
                        updatedData.stock(), updatedData.active()));
    }
    ...
    public long sumActiveStock() {
        return repositoryPort.sumActiveStock();
    }

    public double sumActiveValue() {
        return repositoryPort.sumActiveValue();
    }

    public List<CategoryStockSummary> categoryStockSummaryForActive() {
        return repositoryPort.categoryStockSummaryForActive();
    }
}
